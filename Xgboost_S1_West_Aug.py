...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 13 01:55:27 2025
...
gsearch1 = RandomizedSearchCV(estimator = XGBClassifier(num_class=3,learning_rate =0.10, max_depth=6,
...
plt.title(" West Flow Taxi Exit ROC AUC XGBoost")
plt.legend(loc="lower right")
plt.grid(True)
#plt.show()
plt.savefig('WF_XG_TEXIT_ROC_AUC.jpg', dpi=800)
#plt.show()
...
plt.title("West Flow Taxi Exit Precision–Recall XGBoost")
plt.legend(loc="lower left")
plt.grid(True)
#plt.show()
plt.savefig('WF_XG_TEXIT_PR.jpg', dpi=800)
#plt.show()
...
plt.title("West Flow Taxi Exit Confusion Matrix XGBoost")
#plt.show()
plt.savefig('WF_XG_TEXIT_CMatrix.jpg', dpi=800)
# plt.show()
# print()
# print()
...
plt.savefig("WF_XG_TEXIT_SHAP.png", dpi=600, bbox_inches="tight", pad_inches=0.3)
plt.close(fig)
