...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 13 02:35:34 2025
...
param_test1 = {
    ...
    'max_depth':         randint(3, 8),     # None or 5,10,…,50
...
plt.title(" East Flow Taxi Exit ROC AUC Random Forest")
plt.legend(loc="lower right")
plt.grid(True)
#plt.show()
plt.savefig('EF_RF_TEXIT_ROC.jpg', dpi=800)
#plt.show()
...
plt.title("East Flow Taxi Exit Precision–Recall Random Forest")
plt.legend(loc="lower left")
plt.grid(True)
#plt.show()
plt.savefig('EF_RF_TEXIT_PR.jpg', dpi=800)
#plt.show()
...
plt.title("East Flow Taxi Exit Confusion Matrix Random Forest")
#plt.show()
plt.savefig('EF_RF_TEXIT_CM.jpg', dpi=800)
# plt.show()
# # print()
# # print()
...
plt.savefig("EF_RF_TEXIT_SHAP.png", dpi=600, bbox_inches="tight", pad_inches=0.3)
plt.close(fig)
