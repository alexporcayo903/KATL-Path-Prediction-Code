...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 13 01:38:27 2025
...
gsearch1 = RandomizedSearchCV(estimator = XGBClassifier(num_class=6,learning_rate =0.12, max_depth=6,
...
plt.title(" West Flow Taxi Cross ROC AUC XGBoost")
plt.legend(loc="lower right")
plt.grid(True)
#plt.show()
plt.savefig('WF_XG_CROSS_ROC.jpg', dpi=800)
#plt.show()
...
plt.title("West Flow Taxi Cross Precision–Recall XGBoost")
plt.legend(loc="lower left")
plt.grid(True)
#plt.show()
plt.savefig('WF_XG_CROSS_PR.jpg', dpi=800)
#plt.show()
...
plt.title("West Flow Taxi Cross Confusion Matrix XGBoost")
#plt.show()
plt.savefig('WF_XG_CROSS_CM.jpg', dpi=800)
# plt.show()
# # print()
# # print()
...
plt.savefig("WF_XG_CROSS_SHAP.png", dpi=600, bbox_inches="tight", pad_inches=0.3)
plt.close(fig)
