...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 13 02:24:39 2025
...
param_test1 = {
    ...
    'min_samples_split': randint(1, 11),                     # 2–10
...
plt.title(" West Flow Taxi Exit ROC AUC Random Forest")
plt.legend(loc="lower right")
plt.grid(True)
#plt.show()
plt.savefig('WF_RF_TEXIT_ROC_AUC.jpg', dpi=800)
#plt.show()
...
plt.title("West Flow Taxi Exit Precision–Recall Random Forest")
plt.legend(loc="lower left")
plt.grid(True)
#plt.show()
plt.savefig('WF_RF_TEXIT_PR.jpg', dpi=800)
#plt.show()
...
disp = ConfusionMatrixDisplay(cm, display_labels=['B1','B3','B5'])
disp.plot(cmap=plt.cm.Blues)
plt.title("West Flow Taxi Exit Confusion Matrix Random Forest")
#plt.show()
plt.savefig('WF_RF_TEXIT_CMatrix.jpg', dpi=800)
# plt.show()
# print()
# print()
...
plt.savefig("WF_RF_TEXIT_SHAP.png", dpi=600, bbox_inches="tight", pad_inches=0.3)
plt.close(fig)
...
#     class_names=['B1','B3','B5'],
#     plot_size=(9, 6),  # controls figure size inside SHAP
#     show=True          # don't auto-show; lets us adjust & save cleanly
# )
