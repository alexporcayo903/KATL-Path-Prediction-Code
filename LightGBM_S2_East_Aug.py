...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 13 08:13:50 2025
...
gsearch1 = RandomizedSearchCV(
    ...
    n_iter=50,
    scoring="accuracy",    # or "f1_macro", "neg_log_loss"
    cv=5,
    verbose=0,
    n_jobs=-1,
    random_state=RDN
...
gsearch1.fit(
    ...
    callbacks=[
        ...
        log_evaluation(period=0)   # suppress eval logging
    ]
)
...
plt.title(" East Flow Taxi Cross ROC AUC LightGBM")
plt.legend(loc="lower right")
plt.grid(True)
#plt.show()
plt.savefig('EF_GBM_CROSS_ROC.jpg', dpi=800)
plt.show()
...
plt.title("East Flow Taxi Cross Precision–Recall LightGBM")
plt.legend(loc="lower left")
plt.grid(True)
#plt.show()
plt.savefig('EF_GBM_CROSS_PR.jpg', dpi=800)
plt.show()
...
plt.title("East Flow Taxi Cross Confusion Matrix LightGBM")
#plt.show()
plt.savefig('EF_GBM_CROSS_CM.jpg', dpi=800)
plt.show()
# # print()
# # print()
