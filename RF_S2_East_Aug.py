...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 13 07:48:19 2025
...
plt.title(" East Flow Taxi Cross ROC AUC Random Forest")
plt.legend(loc="lower right")
plt.grid(True)
#plt.show()
plt.savefig('EF_RF_CROSS_ROCAUC.jpg', dpi=800)
#plt.show()
...
plt.title("East Flow Taxi Cross Precision–Recall Random Forest")
plt.legend(loc="lower left")
plt.grid(True)
#plt.show()
plt.savefig('EF_RF_CROSS_PR.jpg', dpi=800)
plt.show()
...
plt.title("East Flow Taxi Cross Confusion Matrix Random Forest")
#plt.show()
plt.savefig('EF_RF_CROSS_CM.jpg', dpi=800)
# plt.show()
# # print()
# # print()
