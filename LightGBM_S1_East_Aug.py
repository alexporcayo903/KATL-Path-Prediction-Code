...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 13 07:56:26 2025
...
plt.title(" East Flow Taxi Exit ROC AUC LightGBM")
plt.legend(loc="lower right")
plt.grid(True)
#plt.show()
plt.savefig('EF_GBM_TEXIT_ROCAUC.jpg', dpi=800)
plt.show()
...
plt.title("East Flow Taxi Exit Precision–Recall LightGBM")
plt.legend(loc="lower left")
plt.grid(True)
#plt.show()
plt.savefig('EF_GBM_TEXIT_PR.jpg', dpi=800)
plt.show()
...
plt.title("East Flow Taxi Exit Confusion Matrix LightGBM")
#plt.show()
plt.savefig('EF_GBM_TEXIT_CM.jpg', dpi=800)
plt.show()
# # print()
# # print()
