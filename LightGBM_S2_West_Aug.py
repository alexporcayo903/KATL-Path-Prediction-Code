...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 13 08:17:55 2025
...
plt.title(" West Flow Taxi Cross ROC AUC LightGBM")
plt.legend(loc="lower right")
plt.grid(True)
#plt.show()
plt.savefig('WF_GBM_CROSS_ROCAUC.jpg', dpi=800)
plt.show()
...
plt.title("West Flow Taxi Cross Precision–Recall LightGBM")
plt.legend(loc="lower left")
plt.grid(True)
#plt.show()
plt.savefig('WF_GBM_CROSS_PR.jpg', dpi=800)
plt.show()
...
plt.title("West Flow Taxi Cross Confusion Matrix LightGBM")
#plt.show()
plt.savefig('WF_GBM_CROSS_CM.jpg', dpi=800)
plt.show()
# # print()
# # print()
